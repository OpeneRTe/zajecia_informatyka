# Programowanie Powitania: Scenariusz Zajęć z Robotem Qoopers

Oto gotowa treść zadania, którą możesz przekazać uczniom (np. w formie karty pracy lub wyświetlić na tablicy). Jest ona oparta na specyfikacji robota Robobloq Qoopers oraz środowisku programowania Scratch 3.0.

---

# Zadanie: Robot wita klasę! 🤖👋
